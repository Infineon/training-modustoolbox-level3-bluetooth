...
/* TODO Ex 02: Include header files */
    ...
    switch( event )
    {
		case BTM_ENABLED_EVT:								// Bluetooth Controller and Host Stack Enabled
			if( WICED_BT_SUCCESS == p_event_data->enabled.status )
			{
				...
				/* TODO Ex 01: Register GATT callback and initialize the GATT database */

				/* TODO Ex 01: Enable/disable pairing */
				
                /* TODO Ex 02: Configure PWM and then disable it. */
		...
		case BTM_BLE_ADVERT_STATE_CHANGED_EVT:					// Advertising State Change
            ...
            /* TODO Ex 02: Turn LED ON, OFF, or blinking based on advertising and connection status */
