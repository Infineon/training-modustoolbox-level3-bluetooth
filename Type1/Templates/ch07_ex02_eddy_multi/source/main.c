    ...
    switch( event )
    {
		case BTM_ENABLED_EVT:								// Bluetooth Controller and Host Stack Enabled
			if( WICED_BT_SUCCESS == p_event_data->enabled.status )
			{
				...
				/* TODO Setup Eddystone advertisement packets and begin multi-advertising for UID */


				/* TODO Setup Eddystone advertisement packets and begin multi-advertising for TLM */
...
void app_set_advertisement_data_uid( void )
{
	/* TODO Setup UID multi-advertising packet */
}
...
void app_set_advertisement_data_tlm( void )
{
	/* TODO Setup TLM multi-advertising packet */
}
