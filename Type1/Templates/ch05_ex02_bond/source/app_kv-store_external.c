...
/**
 * Function Name: app_kvstore_init_api
 *
 * Function Description:
 ...
 *
 */
void app_kvstore_init_api(mtb_kvstore_bd_t* device)
{
    device->read         = bd_read;
...
/**
 * Function Name: app_kvstore_init_bd
 *
 * Function Description:
...
/**
 * Function Name: get_kvstore_init_lib
 *
 * Function Description:
 ...
 *
 */
void app_kvstore_get_params(uint32_t *length, uint32_t *start_addr)
{
