...
void app_set_advertisement_data( void )
{
    ...
    uint8_t adv_data_flags[]     = { /* TODO - use general discoverable and bredr not supported flags*/ };
    uint8_t adv_data_service[]   = { /* TODO - add Eddystone service UUID in little-endian */ };
    uint8_t adv_data_eddy_url[]  = 
    {
        /* TODO - Eddystone service UUID in little-endian */,
        /* TODO - Eddystone frame type for URL */,
        /* TODO - Transmit power */,
        /* TODO - Eddystone URL prefix for https://wwww. */,
        /* TODO - Character list for infineon */,
        /* TODO - Eddystone URL suffix for .com */
     };
